...
const QueryReferencePage = () => (
  <main className="query-reference">
    <Link className="query-reference-back" to="/">
      Back to search
    </Link>

    <h1 className="query-reference-title">Query reference</h1>
    ...
    <section className="query-reference-section" aria-labelledby="query-reference-examples">
      ...
      <p className="query-reference-note">Any number of clauses can be combined in one question.</p>
