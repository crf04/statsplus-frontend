...
export const ARCHETYPE_LOGS = {
  'Perimeter Shot Creator|NYK': [
    { player: 'S. Gilgeous-Alexander', spm: 0.95, date: 'Mar 28', min: 36, pts: 35, reb: 5, ast: 7, fg3m: 2 },
    { player: 'L. Doncic', spm: 0.92, date: 'Mar 14', min: 38, pts: 38, reb: 9, ast: 8, fg3m: 5 },
    { player: 'D. Mitchell', spm: 0.85, date: 'Feb 21', min: 35, pts: 31, reb: 4, ast: 5, fg3m: 4 },
    { player: 'D. Booker', spm: 0.78, date: 'Jan 30', min: 37, pts: 29, reb: 4, ast: 6, fg3m: 3 },
    { player: 'D. DeRozan', spm: 0.7, date: 'Jan 12', min: 34, pts: 24, reb: 3, ast: 4, fg3m: 1 },
  ],
  'Slashing Wing|NYK': [
    { player: 'A. Edwards', spm: 0.75, date: 'Mar 20', min: 37, pts: 27, reb: 6, ast: 4, fg3m: 3 },
    { player: 'J. Williams', spm: 0.62, date: 'Feb 26', min: 34, pts: 22, reb: 5, ast: 5, fg3m: 2 },
    { player: 'B. Ingram', spm: 0.68, date: 'Feb 2', min: 35, pts: 25, reb: 5, ast: 4, fg3m: 2 },
  ],
  'Movement Shooter|NYK': [
    { player: 'B. Hield', spm: 0.62, date: 'Mar 25', min: 29, pts: 19, reb: 3, ast: 2, fg3m: 5 },
    { player: 'M. Beasley', spm: 0.7, date: 'Mar 3', min: 27, pts: 21, reb: 2, ast: 1, fg3m: 6 },
    { player: 'D. Robinson', spm: 0.58, date: 'Jan 27', min: 25, pts: 16, reb: 2, ast: 2, fg3m: 4 },
  ],
  'Stretch Big|NYK': [
    { player: 'L. Markkanen', spm: 0.7, date: 'Mar 31', min: 33, pts: 24, reb: 8, ast: 2, fg3m: 4 },
    { player: 'N. Reid', spm: 0.66, date: 'Mar 20', min: 26, pts: 18, reb: 6, ast: 2, fg3m: 3 },
  ],
  'Spot-Up Specialist|NYK': [
    { player: 'G. Allen', spm: 0.48, date: 'Jan 30', min: 24, pts: 11, reb: 3, ast: 1, fg3m: 3 },
  ],
  'Pick-and-Roll Maestro|BOS': [
    { player: 'C. Cunningham', spm: 0.7, date: 'Mar 26', min: 36, pts: 25, reb: 6, ast: 8, fg3m: 2 },
    { player: 'T. Young', spm: 0.65, date: 'Mar 8', min: 35, pts: 22, reb: 3, ast: 9, fg3m: 2 },
    { player: 'T. Haliburton', spm: 0.58, date: 'Feb 4', min: 34, pts: 19, reb: 4, ast: 10, fg3m: 3 },
  ],
  'Post Scorer / Stretch Big|BOS': [
    { player: 'N. Jokic', spm: 0.8, date: 'Mar 2', min: 37, pts: 31, reb: 13, ast: 8, fg3m: 1 },
    { player: 'D. Sabonis', spm: 0.7, date: 'Feb 10', min: 35, pts: 26, reb: 14, ast: 6, fg3m: 0 },
    { player: 'A. Davis', spm: 0.75, date: 'Jan 23', min: 36, pts: 28, reb: 12, ast: 3, fg3m: 1 },
  ],
  '3&D Wing|BOS': [
    { player: 'H. Jones', spm: 0.32, date: 'Mar 18', min: 33, pts: 9, reb: 4, ast: 2, fg3m: 1 },
    { player: 'D. Finney-Smith', spm: 0.3, date: 'Feb 24', min: 28, pts: 8, reb: 3, ast: 1, fg3m: 2 },
  ],
  Connector: [],
  'Connector|BOS': [
    { player: 'D. Green', spm: 0.28, date: 'Mar 12', min: 31, pts: 8, reb: 9, ast: 7, fg3m: 1 },
  ],
  'Cutting Wing|BOS': [],
