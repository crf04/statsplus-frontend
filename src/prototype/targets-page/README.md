...
| G   | Sheet  | Round 3. The page is the criteria: one section per Target with its Qualifiers editable in the header, the Lab beneath (graded grid + date-ordered games) re-reading as they move; a Draft Target section at the top. |
| H   | Bench  | Round 3. A rail of criteria; the chosen one on the bench as a sentence with live blanks and steppers, the Lab beneath it.                                                                                            |
