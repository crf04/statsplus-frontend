...
| G   | Sheet  | Round 3. The page is the criteria: one read-only section per Target with its Backtest beneath (graded grid + date-ordered games); a Draft Target section at the top is the Lab, re-reading as it is composed. Saved criteria are not editable here (Chris). |
